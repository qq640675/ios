...
- (void)cancelButtonHandler {
    if (self.style == PGDatePickManagerStyle1) {
        ...
        [UIView animateWithDuration:0.2 animations:^{
            self.dismissView.backgroundColor = [KBLACKCOLOR colorWithAlphaComponent:0];
...
- (void)setupStyle1 {
    ...
    [UIView animateWithDuration:0.2 animations:^{
        if (self.isShadeBackgroud) {
            self.dismissView.backgroundColor = [KBLACKCOLOR colorWithAlphaComponent:0.6];
        }
        self.contentView.frame = contentViewFrame;
        self.headerView.frame = headerViewFrame;
        self.datePicker.frame = datePickerFrame;
...
- (void)setIsShadeBackgroud:(BOOL)isShadeBackgroud {
    ...
    if (isShadeBackgroud) {
        ...
        self.dismissView.backgroundColor = KCLEARCOLOR;
    }
}
