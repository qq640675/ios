...
- (CAKeyframeAnimation *)borderColorAnimation {
    ...
    borderColorAnimation.values = @[(__bridge id)ColorWithAlpha(224, 208, 223, 1.0).CGColor,
                                    (__bridge id)ColorWithAlpha(224, 208, 223, 0.7).CGColor,
                                    (__bridge id)ColorWithAlpha(224, 208, 223, 0.4).CGColor,
                                    (__bridge id)ColorWithAlpha(224, 208, 223, 0.0).CGColor];
