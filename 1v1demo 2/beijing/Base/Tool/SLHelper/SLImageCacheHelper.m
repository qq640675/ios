...
#import "SLImageCacheHelper.h"

@implementation SLImageCacheHelper

+ (void)asyncDecodeImage:(NSString *)path complete:(TAsyncImageComplete)complete {
    static dispatch_queue_t queue;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        queue = dispatch_queue_create("com.qiaqia.asyncDecodeImage", DISPATCH_QUEUE_SERIAL);
    });
