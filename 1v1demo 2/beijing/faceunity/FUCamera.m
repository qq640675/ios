...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        videoHDREnabled = YES;
        _preView = [[AVCaptureVideoPreviewLayer alloc] initWithSession:self.captureSession];
    }
    return self;
}
...
- (instancetype)initWithPreview:(AVCaptureVideoPreviewLayer*)preview{
    if (self = [super init]) {
        ...
        videoHDREnabled = YES;
        _preView = [[AVCaptureVideoPreviewLayer alloc] initWithSession:self.captureSession];
        [preview insertSublayer:_preView atIndex:0];
    }
    return self;
}

- (AVCaptureVideoPreviewLayer*)getPre{
    return  _preView;
}
