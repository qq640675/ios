...
//- (TiUIView *)tiUIView{
//    if (!_tiUIView) {
////        TiUIModel *viewModel = [[TiUIModel alloc] initWithAspectRatio:@"full"];
//
//        TiUIModel *viewModel = [[TiUIModel alloc] init];
//        _tiUIView = [[TiUIView alloc] initWithFrame:CGRectMake(0, TiUIScreenHeight, TiUIScreenWidth, TiUIViewBoxTotalHeight) withViewModel:viewModel];
//    }
//    return _tiUIView;
//}
