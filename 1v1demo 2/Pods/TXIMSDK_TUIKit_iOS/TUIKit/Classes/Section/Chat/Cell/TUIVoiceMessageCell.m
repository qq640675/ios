...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _duration.textColor = RGB(51, 51, 51);
        ...
        _voiceReadPoint.frame = CGRectMake(0, 20, 8, 8);
...
- (void)fillWithData:(TUIVoiceMessageCellData *)data;
{
    ...
    if (data.direction == MsgDirectionIncoming) {
        ...
        _duration.textColor = RGB(174, 79, 253);
    }
}
...
//        self.voiceReadPoint.mm_bottom(self.duration.mm_y + self.duration.mm_h).mm_left(self.duration.mm_x);
        self.voiceReadPoint.mm_right(-16);
    }
}
